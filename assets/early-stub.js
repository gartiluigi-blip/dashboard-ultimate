/* early-stub.js · safe boot · final */
(function(){
  'use strict';
  if (window.__UD_EARLY_STUB_SAFE_FINAL__) return;
  window.__UD_EARLY_STUB_SAFE_FINAL__ = true;
  ...
  var VERSION = '20260518g-safe-final';
  var KILL_FLAGS = [
  ...
  function boot(){
    ...
    loadScript('ud-force-runtime-refresh', '/assets/force-runtime-refresh.js?v=' + VERSION, function(){
      ...
      loadScript('ud-core-html-runtime', '/assets/core/html.js?v=' + VERSION, function(){
        purgeLegacy();
        loadScript('ud-final-safe-fix', '/assets/ud-final-fix.js?v=' + VERSION, function(){
          purgeLegacy();
        });
      });
    });
    ...
    setTimeout(function(){ loadScript('ud-final-safe-fix', '/assets/ud-final-fix.js?v=' + VERSION); }, 2200);
    setTimeout(function(){ loadScript('ud-final-safe-fix-late', '/assets/ud-final-fix.js?v=' + VERSION + '-late'); }, 4200);
  }
