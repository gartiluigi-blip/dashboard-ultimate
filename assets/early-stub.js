/* early-stub.js · hard reset boot · V17 */
(function(){
  'use strict';
  if (window.__UD_EARLY_STUB_HARD_RESET__) return;
  window.__UD_EARLY_STUB_HARD_RESET__ = true;
  ...
  var VERSION = '20260518e-hard-reset-v17';
  var KILL_FLAGS = [
  ...
  function purgeLegacy(){
    [
      'v75-forcefix-style','v76-visible-fix-style','v77-ops-fix-style','v78-grade-system-style','v75-home-modules','v75-focus-fab','v75-focus-overlay','v77-overdue-card','v77-chess-card','v77-prio-command','v77-chess-panel','v78-grade-panel','v79-freeze-panel','v80-epfc-display-fix','u20-cockpit','u20-fab','ud-v16-focus','ud-v16-resume','ud-v16-routine','ud-v16-sport','ud-v16-study','ud-v16-chess','ud-v16-extra-progress','ud-v16-extra-progress-wrap'
    ].forEach(function(id){ removeNode(byId(id)); });
    $('[id^="v75-"],[id^="v76-"],[id^="v77-"],[id^="v78-"],[id^="v79-"],[id^="v80-"],.ud-v16-card,.ud-v16-routine-tl,.ud-v16-extra-progress,[class*="u20-resume-card"],[id="p-nutrition"],[id="p-souplesse"],.nutrition-tab,.souplesse-tab').forEach(removeNode);
  }
  ...
  function clearBrowserCaches(){
    ...
    try { localStorage.setItem('dashv2_hard_reset_v17', String(Date.now())); } catch(e){}
  }
  ...
  function boot(){
    ...
    loadScript('ud-force-runtime-refresh', '/assets/force-runtime-refresh.js?v=' + VERSION, function(){
      ...
      loadScript('ud-core-html-runtime', '/assets/core/html.js?v=' + VERSION, function(){
        purgeLegacy();
        loadScript('ud-v17-clean-integration', '/assets/ud-v17-clean-integration.js?v=' + VERSION, function(){
          purgeLegacy();
        });
      });
    });
    ...
    setTimeout(function(){ loadScript('ud-v17-clean-integration', '/assets/ud-v17-clean-integration.js?v=' + VERSION); }, 2200);
    setTimeout(function(){ loadScript('ud-v17-clean-integration-2', '/assets/ud-v17-clean-integration.js?v=' + VERSION + '-late'); }, 4200);
  }
