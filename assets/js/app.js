...
function home(root){const g=el('div',{class:'grid'});g.append(metric('Mission maintenant','Ouvrir Routine: elle donne EPFC du jour + Coding + IA + IoT + Réparation + NL','Voir Routine',()=>{route='routine';render();}));g.append(metric('Score du jour','Routine + sport + étude','Logger',()=>{Store.saveLog(Store.today(),{mood:4});toast('Log rapide enregistré');}));g.append(metric('Sport','Ouvre le module Sport complet','Voir sport',()=>{route='sport';render();}));root.append(g);}
