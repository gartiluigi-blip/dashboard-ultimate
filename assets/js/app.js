...
export const APP_VERSION='5.2.0-nutrition';
...
const modules={nutrition:{load:()=>import('../../modules/nutrition.js?v=20260626-nutrition-1'),fn:'renderNutrition'},home:{load:()=>import('../../modules/home.js?v=20260601-godmode-1'),fn:'renderHome'},routine:{load:()=>import('../../modules/routine.js?v=20260520-soul-1'),fn:'renderRoutine'},sport:{load:()=>import('../../modules/sport.js?v=20260520-soul-1'),fn:'renderSport'},study:{load:()=>import('../../modules/study.js?v=20260601-godmode-1'),fn:'renderStudy'},money:{load:()=>import('../../modules/money.js?v=20260520-soul-1'),fn:'renderMoney'},stats:{load:()=>import('../../modules/stats.js?v=20260601-godmode-1'),fn:'renderStats'},leisure:{load:()=>import('../../modules/leisure.js?v=20260520-soul-1'),fn:'renderLeisure'},settings:{load:()=>import('../../modules/settings.js?v=20260601-godmode-1'),fn:'renderSettings'}};
