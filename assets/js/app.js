...
const names={home:'Mission',routine:'Jour',stats:'Commandement',sport:'Sport',study:'Étude',money:'Argent',leisure:'Loisir',settings:'Système'};
const modules={home:{load:()=>import('../../modules/home.js?v=20260601-godmode-1'),fn:'renderHome'},routine:{load:()=>import('../../modules/routine.js?v=20260520-soul-1'),fn:'renderRoutine'},sport:{load:()=>import('../../modules/sport.js?v=20260520-soul-1'),fn:'renderSport'},study:{load:()=>import('../../modules/study.js?v=20260601-godmode-1'),fn:'renderStudy'},money:{load:()=>import('../../modules/money.js?v=20260520-soul-1'),fn:'renderMoney'},stats:{load:()=>import('../../modules/stats.js?v=20260601-godmode-1'),fn:'renderStats'},leisure:{load:()=>import('../../modules/leisure.js?v=20260520-soul-1'),fn:'renderLeisure'},settings:{load:()=>import('../../modules/settings.js?v=20260601-godmode-1'),fn:'renderSettings'}};
const groups=[['mission','Mission',['home','routine']],['training','Sport',['sport']],['study','Étude',['study']],['money','Argent',['money']],['intel','Stats',['stats']],['life','Loisir',['leisure']],['system','Système',['settings']]];
