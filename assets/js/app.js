import{ $,el,modeBar,setUiMode,toast }from'./ui.js?v=20260520-onyx-stable-1';
import{ renderHome as A }from'../../modules/home.js?v=20260520-onyx-stable-1';
import{ renderRoutine as B }from'../../modules/routine.js?v=20260520-onyx-stable-1';
import{ renderStats as C }from'../../modules/stats.js?v=20260520-onyx-stable-1';
import{ renderSport as D }from'../../modules/sport.js?v=20260520-onyx-stable-1';
import{ renderStudy as E }from'../../modules/study.js?v=20260520-onyx-stable-1';
import{ renderMoney as F }from'../../modules/money.js?v=20260520-onyx-stable-1';
import{ renderLeisure as G }from'../../modules/leisure.js?v=20260520-onyx-stable-1';
import{ renderSettings as H }from'../../modules/settings.js?v=20260520-onyx-stable-1';
import{ renderFuelFab as I }from'../../modules/fuel.js?v=20260520-onyx-stable-1';
...
const groups=[['cockpit','Cockpit',['home','routine','stats']],['training','Entraînement',['sport']],['study','Étude',['study']],['money','Argent',['money']],['life','Vie',['leisure']],['settings','Système',['settings']]];
...
function errorCard(err){const msg=String(err?.stack||err?.message||err||'Erreur inconnue');const c=el('div',{class:'card danger'});c.append(el('h2',{},'Module bloqué · '+(names[route]||route)));c.append(el('div',{class:'small muted'},'Le dashboard reste actif. Retourne à l’accueil ou copie l’erreur.'));
const box=el('textarea',{class:'input',rows:'8'},msg);c.append(box);c.append(el('div',{class:'row'},[el('button',{class:'btn green',onclick:()=>{route='home';localStorage.setItem('ud5_route',route);draw()}},'Retour accueil'),el('button',{class:'btn',onclick:()=>navigator.clipboard.writeText(msg).then(()=>toast('Erreur copiée'))},'Copier erreur'),el('button',{class:'btn',onclick:()=>location.reload()},'Recharger')]));return c}
