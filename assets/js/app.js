...
function render(){nav();const app=$('#app');app.innerHTML='';renderFuel(app,render);({home,routine,sport,study,money,stats,settings}[route]||home)(app);}
...
function money(root){renderMoney(root,render);}
